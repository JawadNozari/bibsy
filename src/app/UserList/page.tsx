...
export default function Home() {
    ...
    const renderUsers = (users: User[]) => {
        return users.map((user) => (
            <tr key={user.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">
                    <div className="flex items-center">
                        <div className="h-4 w-0.5"></div> {user.class}
                    </div>
                </td>
                <td className="px-6 py-4">
                    <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
    ...
    return(
        <main  className="mainbox justify-between p-4">
                                ...
                                <h3 className="text-center text-xl text-gray-900 font-medium leading-8">{"d"}</h3>
                                 ...
                                 <table className="changetext text-xs my-3">
                                     <tbody>
                                         ...
                                         <tr>
                                             <td className="px-2 py-2 text-gray-500 font-semibold">Email</td>
                                             <td className="px-2 py-2">gmail</td>
                                         </tr>
                                         <tr>
                                             <td className="px-2 py-2 text-gray-500 font-semibold">Phone</td>
                                             <td className="px-2 py-2">78426827562</td>
                                         </tr>
                                         <tr>
                                             <td className="px-2 py-2 text-gray-500 font-semibold">Class</td>
                                             <td className="px-2 py-2">T04</td>
                                         </tr>
                                     </tbody>
                                 </table>
            ...
            {/* User List */}
            <div className="changebox overflow-y-scroll relative shadow-md sm:rounded-lg">
                <div className="flex items-center  sticky top-0 justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900">
                <div>
                        <h2 className="text-xl font-bold px-4 py-2">User list</h2>           
                     </div>
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody >
                        {apiData && (
                            <>
                                <tr>
                                    <th colSpan={4} className="text-lg font-bold px-6 py-4">Staff Users:</th>
                                </tr>
                                {renderUsers(apiData.staffUsers)}

                                <tr>
                                    <th colSpan={4} className="text-lg font-bold px-6 py-4">Student Users:</th>
                                </tr>
