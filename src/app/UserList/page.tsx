...
export default function Home() {
  ...
  return (
    <main className="flex border items-center h-screen justify-around p-4">
          ...
          <div className="p-2 max-h-screen ">
            ...
            <table className="text-1xl my-2">
              ...
              {selectedUser?.classroom ? (
                ...
                <tbody>
                  <tr>
                    <td className="px-4 py-1 text-gray-500 font-semibold">Email</td>
                    <td className="px-4 py-1">{selectedUser?.email}</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-1 text-gray-500 font-semibold">Phone</td>
                    <td className="px-4 py-1">{selectedUser?.phone}</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-1 text-gray-500 font-semibold">Class</td>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="px-4 py-1 text-gray-500 font-semibold">Admin</td>
                    <td className="px-4 py-1">{selectedUser?.admin ? "Yes" : "No"}</td>
                  </tr>
                </tbody>
              )}
            </table>
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-48 top-42">
              <li>
                ...
                <button onClick={() => handleUserTypeChange("all")}>All Users</button>
              </li>
              <li>
                {/* biome-ignore lint/a11y/useButtonType: <explanation> */}
                <button onClick={() => handleUserTypeChange("staff")}>Staffs</button>
              </li>
              <li>
                {/* biome-ignore lint/a11y/useButtonType: <explanation> */}
                <button onClick={() => handleUserTypeChange("student")}>Students</button>
              </li>
            </ul>
          </div>
	  ...
	  <StaticModal showModal={showModal} toggleModal={toggleModal} selectedUser={selectedUser} />
    </main>
  );
}
